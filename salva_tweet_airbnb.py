...
def get_all_tweets(screen_name, cursor, idusur):
        ...
        # Chamada inicial para pegar os 200
        ...
        with connection.cursor() as cursor:
                for tweet in alltweets:
                        ...
                        sql = "INSERT INTO tweetAirbnbLang(tweetId,data,screenName,tweet,lang) VALUES (%s,%s,%s,%s,%s)"
...
if __name__ == '__main__':
        ...
        with connection.cursor() as cursor:
                sql = "SELECT id, screenName, quadrante FROM `contasTweet`"
                cursor.execute(sql)
