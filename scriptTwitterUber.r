...
ggplot(DATA_DT, aes(log(1+followersCount))) + geom_histogram(bins=100)
ggplot(DATA_DT[statusCount > 10], aes(log(1+statusCount))) + geom_histogram(bins=100)
...
igualazeroPerc <- nrow(igualazero) / 256940
menorigualdezPerc <- nrow(menorigualdez) / 256940
menorigualacemPerc <- nrow(menorigualacem) / 256940
maiorigualdoismilPerc <- nrow(maiorigualdoismil) / 256940
...
ggplot(DATA_DT[followersCount > 100], aes(followersCount)) + geom_histogram() 
...
ggplot(DATA_DT[followersCount < 10000], aes(1+followersCount)) + geom_histogram(bins = 100)
ggplot(DATA_DT[followersCount > 0], aes(log(1+followersCount))) + geom_histogram(bins = 100)
